...
export class OnboardingController {
  ...
  async getOnboardingStatus(@Req() req: Request) {
    ...
    try {
      ...
      this.logger.error(
        `Error getting onboarding status for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async initializeOnboarding(@Req() req: Request) {
    ...
    try {
      ...
      this.logger.error(
        `Error initializing onboarding for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async updateOnboardingStep(
    ...
    try {
      ...
      this.logger.log(
        `Onboarding step updated for user: ${userId} to step: ${updateStepDto.currentStep}`,
      );
      return {
        success: true,
        data: onboardingProgress,
      ...
      this.logger.error(
        `Error updating onboarding step for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async completeOnboardingStep(
    ...
    try {
      ...
      this.logger.log(
        `Onboarding step completed for user: ${userId}, step: ${completeStepDto.step}`,
      );
      return {
        success: true,
        data: onboardingProgress,
      ...
      this.logger.error(
        `Error completing onboarding step for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async selectUserRole(
    ...
    try {
      ...
      this.logger.log(
        `User role selected for user: ${userId}, role: ${selectRoleDto.role}`,
      );
      return {
        success: true,
        data: {
      ...
      this.logger.error(
        `Error selecting user role for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async setupSchool(
    ...
    try {
      ...
      this.logger.log(
        `School setup completed for user: ${userId}, school: ${school.name}`,
      );
      return {
        success: true,
        data: {
      ...
      this.logger.error(
        `Error setting up school for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async logAnalyticsEvent(
    ...
    try {
      ...
      this.logger.error(
        `Error logging analytics event for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async skipOnboarding(
    ...
    try {
      ...
      this.logger.log(
        `Onboarding skipped for user: ${userId}, reason: ${body.reason || 'No reason provided'}`,
      );
      return {
        success: true,
        data: result,
      ...
      this.logger.error(
        `Error skipping onboarding for user ${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
