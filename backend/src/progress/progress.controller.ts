...
import { UserProgressService, CourseProgressSummary } from './services/user-progress.service';
...
export class ProgressController {
  ...
  async getUserCourseProgress(
    ...
    try {
      return await this.userProgressService.getUserCourseProgress(userId, courseId);
    } catch (error) {
  ...
  async getUserCoursesProgress(
    ...
    try {
      return await this.userProgressService.getUserCoursesProgress(userId, schoolId);
    } catch (error) {
  ...
  async getUserClassProgressInCourse(
    ...
    try {
      return await this.userProgressService.getUserClassProgressInCourse(userId, courseId);
    } catch (error) {
  ...
  async getPublicUserCourseProgress(
    ...
    try {
      ...
      this.logger.error(`Error getting public user course progress: ${error.message}`);
      throw error;
    }
  }
  ...
  async getPublicUserCoursesProgress(
    ...
    try {
      ...
      this.logger.error(`Error getting public user courses progress: ${error.message}`);
      throw error;
    }
  }
} 