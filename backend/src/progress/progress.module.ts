...
import { UserClassProgress, UserClassProgressSchema } from './schemas/user-class-progress.schema';
import { UserCourseProgress, UserCourseProgressSchema } from './schemas/user-course-progress.schema';
