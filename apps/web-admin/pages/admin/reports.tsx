...
export default function Reports() {
  ...
  const loadUserSchools = async (userToken: DecodedToken) => {
    try {
      ...
      // Auto-select first school if available (always auto-select to simplify UX)
      if (schoolsData.length >= 1) {
        console.log(`Auto-selecting first school:`, schoolsData[0].name);
            ...
            <div className={styles.filterSection}>
              ...
              <div className={styles.filterGroup}>
                ...
                <select 
                  ...
                  disabled={!['super_admin', 'admin'].includes(user?.role?.toLowerCase() ?? '') && schools.length <= 1}
                >
              ...
              <div className={styles.reportHeader}>
                <div className={styles.reportTitleRow}>
                  ...
                  <div className={styles.exportButtonContainer}>
                    ...
                    >
                      {exporting ? 'Exportando...' : 'Descargar Excel Detallado'}
                    </button>
                  </div>
                </div>
              </div>
