...
export default function CreateClass() {
  ...
  }, [router, fetchCourses, fetchCreatorTermsStatus]);
    ...
    try {
      ...
      if (!creatorTermsStatus?.accepted) {
        if (!acceptCreatorTermsChecked) {
          setError('Debes aceptar los términos de creador para subir contenido.');
          setLoading(false);
          return;
        }
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.formGroup}>
                <label className={styles.checkboxLabel}>
                  <input
                    ...
                    disabled={loading}
                  />
                  Confirmo que el contenido cumple políticas de la comunidad y derechos de autor.
                </label>
                <p className={styles.inputHelp}>
            ...
            <div className={styles.buttonGroup}>
              <button
                ...
                disabled={loading || (!creatorTermsStatus?.accepted && !acceptCreatorTermsChecked)}
              >
                {loading ? (
                  <>
