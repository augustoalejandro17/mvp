      ...
      <ScrollView className="flex-1 bg-amber-50" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-amber-500 px-5 pt-5 pb-8 flex-row items-center">
          ...
          <View className="flex-1">
            ...
            <Text className="text-white text-xl font-bold">Nueva Clase</Text>
          </View>
        </View>
        ...
        <View className="px-4 -mt-4">
          ...
          <View className="flex-row items-start bg-blue-50 border border-blue-100 rounded-2xl p-3 mb-4">
            ...
            <Text className="text-blue-700 text-xs ml-2 flex-1">
              Después de crear la clase, sube el video desde el panel web para completarla.
            </Text>
          </View>
          ...
          <View className="bg-white rounded-2xl p-4 mb-4 shadow-sm" style={{ shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, elevation: 3 }}>
            ...
            <View className="mb-4">
              ...
              />
              <Text className="text-gray-400 text-xs mt-1 text-right">{description.length} / 10 min</Text>
            </View>

            <View className="mb-4">
              <Text className="text-gray-700 font-semibold text-sm mb-1.5">Orden</Text>
              <TextInput
                value={order}
          ...
          >
            {isSaving ? (
              ...
              <Text className="text-white font-bold text-base">Crear Clase</Text>
            )}
          </TouchableOpacity>
